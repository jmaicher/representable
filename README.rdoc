...
You have a collection of different class types? The +PolymorphicExtender+ searches for an appropriate representer! So, Peter's friends can be heroes or superheroes.

  module HeroRepresenter
    collection :friends, :extend => PolymorphicExtender
  end
